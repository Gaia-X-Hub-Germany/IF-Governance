...
This is the repository for the Data Space Implementation Forum "Organisational Form and Governance Authority", dealing with the DSSC Building Block of the same name.
